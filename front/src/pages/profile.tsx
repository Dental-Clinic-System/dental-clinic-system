  ...
  return (
    <Box sx={{
      ...
      <Box sx={{ justifyContent: 'center' }} >
        <h1>Work Schedule</h1>
        <Box>
          <h3>Mon: {mockdata.timestamp.mon}</h3>
          <h3>Tue: {mockdata.timestamp.tue}</h3>
          <h3>Wed: {mockdata.timestamp.wed}</h3>
          <h3>Thu: {mockdata.timestamp.thu}</h3>
          <h3>Fri: {mockdata.timestamp.fri}</h3>
        </Box>
      </Box>
    </Box>
  )
