import { ClinicModel, UserModel, PatientModel, ServiceModel, AppointmentModel, PermissionModel, RoleModel, ProviceModel, DistrictModel, CommitteeModel } from '../models/schemas'
...
const queries = {
    ...
    getAppointments: async (_: any, params: any) => await AppointmentModel.find(params).populate('clinic'),
